...
var lengthBufConstructorParams = []byte{136}
...
func (t *ConstructorParams) MarshalCBOR(w io.Writer) error {
	...
	// t.FirstRoundEpoch (abi.ChainEpoch) (int64)
	if t.FirstRoundEpoch >= 0 {
		if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.FirstRoundEpoch)); err != nil {
			return err
		}
	} else {
		if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajNegativeInt, uint64(-t.FirstRoundEpoch-1)); err != nil {
			return err
		}
	}
...
func (t *ConstructorParams) UnmarshalCBOR(r io.Reader) error {
	*t = ConstructorParams{}
	...
	// t.FirstRoundEpoch (abi.ChainEpoch) (int64)
	{
		...
		t.FirstRoundEpoch = abi.ChainEpoch(extraI)
	}
	// t.MinDepositAmount (big.Int) (struct)
...
var lengthBufWithdrawParams = []byte{129}

func (t *WithdrawParams) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufWithdrawParams); err != nil {
		return err
	}
...
func (t *WithdrawParams) UnmarshalCBOR(r io.Reader) error {
	*t = WithdrawParams{}
...
var lengthBufChangeMaturePeriodParams = []byte{129}

func (t *ChangeMaturePeriodParams) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufChangeMaturePeriodParams); err != nil {
		return err
	}
...
func (t *ChangeMaturePeriodParams) UnmarshalCBOR(r io.Reader) error {
	*t = ChangeMaturePeriodParams{}
...
var lengthBufChangeRoundPeriodParams = []byte{129}

func (t *ChangeRoundPeriodParams) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufChangeRoundPeriodParams); err != nil {
		return err
	}
...
func (t *ChangeRoundPeriodParams) UnmarshalCBOR(r io.Reader) error {
	*t = ChangeRoundPeriodParams{}
...
var lengthBufChangePrincipalLockDurationParams = []byte{129}

func (t *ChangePrincipalLockDurationParams) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufChangePrincipalLockDurationParams); err != nil {
		return err
	}
...
func (t *ChangePrincipalLockDurationParams) UnmarshalCBOR(r io.Reader) error {
	*t = ChangePrincipalLockDurationParams{}
...
var lengthBufChangeMinDepositAmountParams = []byte{129}

func (t *ChangeMinDepositAmountParams) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufChangeMinDepositAmountParams); err != nil {
		return err
	}
...
func (t *ChangeMinDepositAmountParams) UnmarshalCBOR(r io.Reader) error {
	*t = ChangeMinDepositAmountParams{}
...
var lengthBufChangeMaxRewardsPerRoundParams = []byte{129}

func (t *ChangeMaxRewardsPerRoundParams) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufChangeMaxRewardsPerRoundParams); err != nil {
		return err
	}
...
func (t *ChangeMaxRewardsPerRoundParams) UnmarshalCBOR(r io.Reader) error {
	*t = ChangeMaxRewardsPerRoundParams{}
...
var lengthBufChangeInflationFactorParams = []byte{129}

func (t *ChangeInflationFactorParams) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufChangeInflationFactorParams); err != nil {
		return err
	}
...
func (t *ChangeInflationFactorParams) UnmarshalCBOR(r io.Reader) error {
	*t = ChangeInflationFactorParams{}
